...
const first = <button className="w-[60px] py-1 bg-[#00853e] text-white text-[16px] rounded-[15px]">ดีที่สุด</button>
const second = <button className="w-[60px] py-1 bg-[#00e76b] text-white text-[16px] rounded-[15px]">ดีมาก</button>
const third = <button className="w-[60px] py-1 bg-[#74ffb4] text-white text-[16px] rounded-[15px]">ดี</button>
    ...
    return (
        <div className="pb-[50px] px-6 py-6">
            ...
            <div className=" grid grid-cols-2 gap-x-8">
                ...
                >
                    <div className="pt-8 pb-2 font-bold text-[20px] text-[#072C29]">Performance</div>
                ...
                >
                    <div className="flex pt-8 pb-2">
                        <button className={`${stat === 'SD' ? "text-[#072C29] font-bold underline" : "text-gray-600 font-semibold"} px-5  text-[20px]  hover:bg-gray-100 rounded-[10px]`} onClick={() => setStat('SD')}>SD</button>
                        <button className={`${stat === 'Sharpe Ratio' ? "text-[#072C29] font-bold underline" : "text-gray-600 font-semibold"} px-5  text-[20px]  hover:bg-gray-100 rounded-[10px]`} onClick={() => setStat('Sharpe Ratio')}>Sharpe Ratio</button>
                        <button className={`${stat === 'Max Drawdown' ? "text-[#072C29] font-bold underline" : "text-gray-600 font-semibold"} px-5  text-[20px]  hover:bg-gray-100 rounded-[10px]`} onClick={() => setStat('Max Drawdown')}>Max Drawdown</button>
                    </div>
                    <div className="text-[18px] text-gray-600">
                        <div className="grid grid-cols-4"><p className="flex justify-center py-2 col-start-3">กองนี้</p><p className="flex justify-center py-2">เฉลี่ยในกลุ่ม</p></div>
                        <div className="grid grid-cols-4 pt-4 pb-1"><p>3M</p><p className="flex justify-center col-start-3">9.44%</p><p className="flex justify-center">10.29%</p></div>
            ...
            <span className='flex items-center px-2 py-4 pb-11 text-[16px] text-[#7c8594]'><Clock size={18} className='mr-[6px]'/> ข้อมูล ณ วันที่ 20 มี.ค. 2567</span>
            <div className="bg-white px-8 py-6 shadow-md rounded-[10px] space-y-4 text-[17px] text-gray-700">
