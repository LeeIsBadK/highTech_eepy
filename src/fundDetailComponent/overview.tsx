      ...
      <div className="grid grid-cols-7 gap-x-0 px-8 py-6 bg-[#eaeaea] rounded-[10px] shadow-md">
        ...
        {fundData ? (
          <div className="grid grid-cols-3 col-start-3 col-span-3">
            <span className={`${fundData.fund_resYTD['3_month'].includes('-') ? 'text-[#ef5350]' : 'text-[#00bc91]'} flex flex-col text-[13px] md:text-[16px] lg:text-[18px] 2xl:text-[22px] font-bold items-center`}>
            ...
            <span className={`${fundData.fund_resYTD['6_month'].includes('-') ? 'text-[#ef5350]' : 'text-[#00bc91]'} flex flex-col text-[13px] md:text-[16px] lg:text-[18px] 2xl:text-[22px] font-bold items-center border-x border-gray-400`} >
            ...
            <span className={`${fundData.fund_resYTD['1_year'].includes('-') ? 'text-[#ef5350]' : 'text-[#00bc91]'} flex flex-col text-[13px] md:text-[16px] lg:text-[18px] 2xl:text-[22px] font-bold items-center`}>
