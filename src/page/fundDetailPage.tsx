        ...
        <div className="flex items-center mb-6 py-6 px-6 lg:px-8 bg-white shadow-md rounded-[10px]">
          <div className='px-2 w-full'>
            ...
            <div className='flex'>
              ...
              {fundData && fundData.Allinfo.nav && fundData.Allinfo.nav.NAV && fundData.Allinfo.nav.NAV.length !== 0 && fundData.Allinfo.nav.NAV[0].length > 2 && fundData.dailydate && fundData.dailydate !== '-' && (
